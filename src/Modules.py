...
class Sequential(Module):
    ...
    def __init__(self, *Modules):
        """
            Initializes an instance of a Sequential object.
            If one of the argument is a Sequential object itself, it will take its members as its own,
            allowing to build a Sequential from multiple sequential and modules objects.
        """
        super(Sequential, self).__init__()
        self.parameters = []
        self.members = []
        #Allows to build a Sequential object from multiple Sequential objects.
        for module in Modules:
            if type(module) == Sequential:
